...
namespace Affinity
{
	...
	public partial class Order : Loadable
	{
		...
		public bool IsDemo
		{
			...
			set { this._isDemo = value; }
		}

		private string _identifierNumber = "";
		public string IdentifierNumber
		{
			get { return this._identifierNumber; }
			set { this._identifierNumber = value; }
		}
		...
		protected override string GetUpdateSql()
		{
			...
			sb.Append(" ,o_is_demo = " + ((this.IsDemo)? "1" : "0"));
			sb.Append(" ,o_identifier_number = '" + Preparer.Escape(this.IdentifierNumber) + "'");
		...
		protected override string GetInsertSql()
		{
			...
			sb.Append(" ," + ((this.IsDemo)? "1" : "0"));
			sb.Append(" ,'" + Preparer.Escape(this.IdentifierNumber) + "'");
			sb.Append(" )");
		...
		public override void Load(MySqlDataReader reader)
		{
		   ...
		   this.IsDemo = Preparer.SafeBool(reader["o_is_demo"]);
		   this.IdentifierNumber = Preparer.SafeString(reader["o_identifier_number"]);

            try
            {
                this.PurposeCode = reader["att_purpose_code"].ToString();
            }
            catch (Exception) { }
