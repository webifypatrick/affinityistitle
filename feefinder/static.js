...
FIRST_LOAN_POLICY_RATE['purchase'] = 500;
...
RESIDENTIAL_RATES[0] = {min: 0, max: 100000, rate: 1050};
RESIDENTIAL_RATES[1] = {min: 100001, max: 150000, rate: 1100};
RESIDENTIAL_RATES[2] = {min: 150001, max: 200000, rate: 1150};
RESIDENTIAL_RATES[3] = {min: 200001, max: 250000, rate: 1200};
RESIDENTIAL_RATES[4] = {min: 250001, max: 300000, rate: 1250};
RESIDENTIAL_RATES[5] = {min: 300001, max: 400000, rate: 1300};
RESIDENTIAL_RATES[6] = {min: 400001, max: 500000, rate: 1350};
...
SERVICE_RATES['after_hours_closing'] = {purchase: 150, refi: 150, agent_refi: 150, multiplier: ''};
...
SERVICE_RATES['dry_closing'] = {purchase: 150, refi: 150, agent_refi: 150, multiplier: ''};
...
ENDORSEMENT_RATES['simultaneously_issued_mortgage_policy'] = {purchase: 500, refi: 0, agent_refi: 0, multiplier: ''};
ENDORSEMENT_RATES['condominium'] = {purchase: 175, refi: 0, agent_refi: 0, multiplier: ''};
ENDORSEMENT_RATES['planned_unit'] = {purchase: 175, refi: 0, agent_refi: 0, multiplier: ''};
ENDORSEMENT_RATES['variable_rate'] = {purchase: 175, refi: 0, agent_refi: 0, multiplier: ''};
ENDORSEMENT_RATES['negative_amortization'] = {purchase: 175, refi: 0, agent_refi: 1, multiplier: ''};
ENDORSEMENT_RATES['manufacturing_housing'] = {purchase: 175, refi: 0, agent_refi: 0, multiplier: ''};
ENDORSEMENT_RATES['epa'] = {purchase: 175, refi: 0, agent_refi: 0, multiplier: ''};
ENDORSEMENT_RATES['restrinctions_encroachments_minerals'] = {purchase: 175, refi: 0, agent_refi: 0, multiplier: ''};
ENDORSEMENT_RATES['location'] = {purchase: 175, refi: 0, agent_refi: 0, multiplier: ''};
ENDORSEMENT_RATES['balloon'] = {purchase: 175, refi: 0, agent_refi: 0, multiplier: ''};
ENDORSEMENT_RATES['pud'] = {purchase: 175, refi: 0, agent_refi: 0, multiplier: ''};
ENDORSEMENT_RATES['revolving_credit'] = {purchase: 175, refi: 0, agent_refi: 0, multiplier: ''};
ENDORSEMENT_RATES['other'] = {purchase: 0, refi: 0, agent_refi: 0, multiplier: '', contact_us: true};
ENDORSEMENT_RATES['arm'] = {purchase: 175, refi: 0, agent_refi: 0, multiplier: ''};
...
INSURANCE_RATES[0] = {min: 0, max: 100000, rate: 1200};
INSURANCE_RATES[1] = {min: 1000001, max: 110000, rate: 1220};
INSURANCE_RATES[2] = {min: 110001, max: 120000, rate: 1240};
INSURANCE_RATES[3] = {min: 120001, max: 130000, rate: 1260};
INSURANCE_RATES[4] = {min: 130001, max: 140000, rate: 1280};
INSURANCE_RATES[5] = {min: 140001, max: 150000, rate: 1300};
INSURANCE_RATES[6] = {min: 150001, max: 160000, rate: 1320};
INSURANCE_RATES[7] = {min: 160001, max: 170000, rate: 1340};
INSURANCE_RATES[8] = {min: 170001, max: 180000, rate: 1360};
INSURANCE_RATES[9] = {min: 180001, max: 190000, rate: 1380};
INSURANCE_RATES[10] = {min: 190001, max: 200000, rate: 1400};
INSURANCE_RATES[11] = {min: 200001, max: 210000, rate: 1420};
INSURANCE_RATES[12] = {min: 210001, max: 220000, rate: 1440};
INSURANCE_RATES[13] = {min: 220001, max: 230000, rate: 1460};
INSURANCE_RATES[14] = {min: 230001, max: 240000, rate: 1480};
INSURANCE_RATES[15] = {min: 240001, max: 250000, rate: 1500};
INSURANCE_RATES[16] = {min: 250001, max: 260000, rate: 1520};
INSURANCE_RATES[17] = {min: 260001, max: 270000, rate: 1540};
INSURANCE_RATES[18] = {min: 270001, max: 280000, rate: 1560};
INSURANCE_RATES[19] = {min: 280001, max: 290000, rate: 1580};
INSURANCE_RATES[20] = {min: 290001, max: 300000, rate: 1600};
INSURANCE_RATES[21] = {min: 300001, max: 310000, rate: 1620};
INSURANCE_RATES[22] = {min: 310001, max: 320000, rate: 1640};
INSURANCE_RATES[23] = {min: 320001, max: 330000, rate: 1660};
INSURANCE_RATES[24] = {min: 330001, max: 340000, rate: 1680};
INSURANCE_RATES[25] = {min: 340001, max: 350000, rate: 1700};
INSURANCE_RATES[26] = {min: 350001, max: 360000, rate: 1720};
INSURANCE_RATES[27] = {min: 360001, max: 370000, rate: 1740};
INSURANCE_RATES[28] = {min: 370001, max: 380000, rate: 1760};
INSURANCE_RATES[29] = {min: 380001, max: 390000, rate: 1780};
INSURANCE_RATES[30] = {min: 390001, max: 400000, rate: 1800};
INSURANCE_RATES[31] = {min: 400001, max: 410000, rate: 1820};
INSURANCE_RATES[32] = {min: 410001, max: 420000, rate: 1840};
INSURANCE_RATES[33] = {min: 420001, max: 430000, rate: 1860};
INSURANCE_RATES[34] = {min: 430001, max: 440000, rate: 1880};
INSURANCE_RATES[35] = {min: 440001, max: 450000, rate: 1900};
INSURANCE_RATES[36] = {min: 450001, max: 460000, rate: 1920};
INSURANCE_RATES[37] = {min: 460001, max: 470000, rate: 1940};
INSURANCE_RATES[38] = {min: 470001, max: 480000, rate: 1960};
INSURANCE_RATES[39] = {min: 480001, max: 490000, rate: 1980};
INSURANCE_RATES[40] = {min: 490001, max: 500000, rate: 2000};
INSURANCE_RATES[41] = {min: 500001, max: 510000, rate: 2045};
INSURANCE_RATES[42] = {min: 510001, max: 520000, rate: 2065};
INSURANCE_RATES[43] = {min: 520001, max: 530000, rate: 2085};
INSURANCE_RATES[44] = {min: 530001, max: 540000, rate: 2105};
INSURANCE_RATES[45] = {min: 540001, max: 550000, rate: 2125};
INSURANCE_RATES[46] = {min: 550001, max: 560000, rate: 2145};
INSURANCE_RATES[47] = {min: 560001, max: 570000, rate: 2165};
INSURANCE_RATES[48] = {min: 570001, max: 580000, rate: 2185};
INSURANCE_RATES[49] = {min: 580001, max: 590000, rate: 2205};
INSURANCE_RATES[50] = {min: 590001, max: 600000, rate: 2225};
INSURANCE_RATES[51] = {min: 600001, max: 610000, rate: 2245};
INSURANCE_RATES[52] = {min: 610001, max: 620000, rate: 2265};
INSURANCE_RATES[53] = {min: 620001, max: 630000, rate: 2285};
INSURANCE_RATES[54] = {min: 630001, max: 640000, rate: 2305};
INSURANCE_RATES[55] = {min: 640001, max: 650000, rate: 2325};
INSURANCE_RATES[56] = {min: 650001, max: 660000, rate: 2345};
INSURANCE_RATES[57] = {min: 660001, max: 670000, rate: 2365};
INSURANCE_RATES[58] = {min: 670001, max: 680000, rate: 2385};
INSURANCE_RATES[59] = {min: 680001, max: 690000, rate: 2405};
INSURANCE_RATES[60] = {min: 690001, max: 700000, rate: 2425};
INSURANCE_RATES[61] = {min: 700001, max: 710000, rate: 2445};
INSURANCE_RATES[62] = {min: 710001, max: 720000, rate: 2465};
INSURANCE_RATES[63] = {min: 720001, max: 730000, rate: 2485};
INSURANCE_RATES[64] = {min: 730001, max: 740000, rate: 2505};
INSURANCE_RATES[65] = {min: 740001, max: 750000, rate: 2525};
INSURANCE_RATES[66] = {min: 750001, max: 760000, rate: 2545};
INSURANCE_RATES[67] = {min: 760001, max: 770000, rate: 2565};
INSURANCE_RATES[68] = {min: 770001, max: 780000, rate: 2585};
INSURANCE_RATES[69] = {min: 780001, max: 790000, rate: 2605};
INSURANCE_RATES[70] = {min: 790001, max: 800000, rate: 2625};
INSURANCE_RATES[71] = {min: 800001, max: 810000, rate: 2645};
INSURANCE_RATES[72] = {min: 810001, max: 820000, rate: 2665};
INSURANCE_RATES[73] = {min: 820001, max: 830000, rate: 2685};
INSURANCE_RATES[74] = {min: 830001, max: 840000, rate: 2705};
INSURANCE_RATES[75] = {min: 840001, max: 850000, rate: 2725};
INSURANCE_RATES[76] = {min: 850001, max: 860000, rate: 2745};
INSURANCE_RATES[77] = {min: 860001, max: 870000, rate: 2765};
INSURANCE_RATES[78] = {min: 870001, max: 880000, rate: 2785};
INSURANCE_RATES[79] = {min: 880001, max: 890000, rate: 2805};
INSURANCE_RATES[80] = {min: 890001, max: 900000, rate: 2825};
INSURANCE_RATES[81] = {min: 900001, max: 910000, rate: 2845};
