...
namespace Affinity
{
    public partial class AgentExaminationForm : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ((Affinity.MasterPage)this.Master).SetLayout("Agent Examination Form", MasterPage.LayoutStyle.ContentOnly);
        ...
        protected void saveAgentExaminationForm(bool submitted, Affinity.Account me)
        {
            ...
            try
            {
                ...
                if (submitted)
                {
                    ...
                    */
                    ...
                    /*
                    txtEmailNote.Text = "'" + att.Name + "' has been uploaded.  "
                        + txtEmailNote.Text;
                ...
                SendNotification(oldStatus, newStatus, filePosted, txtEmailNote.Text);
                    */
                    ...
                    else
                    {
                        ...
                        log.Debug("AgentExaminationForm: Attachment: fileName: " + fileName);
                        ...
                        log.Debug("AgentExaminationForm: Attachment: isNotSurveyServices: " + isNotSurveyServices.ToString() + " state: " + state);
                        ...
                        log.Debug("AgentExaminationForm: Attachment: to: " + to);
                        MailMessage mm = new MailMessage(this.GetSystemSetting("SendFromEmail"), to, "Agent Examination Form " + commitment, "Agent Examination Form has been submitted by: " + me.FirstName + " " + me.LastName + "<br /><br /><br />\r\n\r\n" + this.GetSystemSetting("EmailFooter"));
                        mm.IsBodyHtml = true;
                        ...
                        if (mailer.Send(mm))
                        {
                            log.Debug("AgentExaminationForm: Attachment: Mail Sent: successfully");
                        }
                        else
                        {
                            log.Debug("AgentExaminationForm: Attachment: Mail Sent: failed");
                        }
                    }
            ...
            {
                //((Affinity.MasterPage)this.Master).ShowFeedback(ex.Message, MasterPage.FeedbackType.Information);
                //Response.Write(ex.Message);
                Response.End();
            }
        }
