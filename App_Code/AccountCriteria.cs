...
namespace Affinity
{
	...
	public class AccountCriteria : Criteria
	{
        ...
        public bool showOnlyAffinity = false;
        public bool showNoAffinity = false;
		...
		protected override string GetWhereSql()
		{
            ...
            if (showNoAffinity)
            {
                sb.Append(delim + "a.a_email NOT LIKE '%affinityistitle.com' and a.a_id > 2 and a.a_last_name <> '.' and a.a_last_name <> '..' and a.a_id NOT IN (89, 189)");
                delim = " and ";
            }

            if (showOnlyAffinity)
            {
                sb.Append(delim + "a.a_email LIKE '%affinityistitle.com'");
                delim = " and ";
            }
